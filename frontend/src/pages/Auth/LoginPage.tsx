        ...
        >
            ...
            >
                <div className="p-8 space-y-6">
                    <h2 className="text-center text-2xl font-semibold text-gray-900 dark:text-gray-100">{t('auth.login')}</h2>
                    ...
                    <p className="text-center text-sm text-gray-600 dark:text-gray-400">
                        {t('auth.askAccount')}{' '}
                        <Link to="/register" className="text-indigo-700 dark:text-indigo-300 hover:underline">
                            {t('auth.signUp')}
                        </Link>
                    </p>
                </div>
